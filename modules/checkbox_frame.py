...
class CheckboxFrame(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        self.recursive.grid(row=0, column=1, pady=5, padx=5, sticky="w")
        self.names_as_albums = ctk.CTkCheckBox(self, text="Directories as albums", variable=self.names_as_albums)
        self.names_as_albums.grid(row=0, column=0, pady=5, padx=5, sticky="w")
        ...
        self.names_as_tags.grid(row=1, column=0, padx=5, pady=5, sticky="w")
        ...
        self.import_captions.grid(row=1, column=1, padx=5, pady=5, sticky="w")
